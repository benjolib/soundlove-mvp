...
{
    NSString *urlString = [NSString stringWithFormat:@"%@access_token=%@&user_id=%@", kArtistRecommended, [FacebookManager currentUserAccessToken], [FacebookManager currentUserID]];
